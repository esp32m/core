  ...
  i18n: {
    resources: {
      ...
      it: {
        ...
        'Enable time synchronization': 'Abilita sincronizzazione oraria',
        'Time zone setting': 'Impostazione fuso orario',
        'NTP hostname': 'Nome host NTP',
        'Interval, s': 'Intervallo, s',
        'Last synchronization': 'Ultima sincronizzazione',
        'Current on-chip local time': 'Ora locale corrente sul chip',
        'never happened': 'mai accaduto',
        'SNTP Time Synchronization': 'Sincronizzazione oraria SNTP',
        Autodetect: 'Rilevamento automatico',
        'Synchronize now': 'Sincronizza ora',
        'SNTP time sync': 'Sincronizzazione oraria',
      },
    },
  },
};
