...
const scales = keyframes`from{transform:scale(0.98)}to{transform:scale(1)}`;
const rotatepao = keyframes`0%{transform:rotate(0deg)}50%,60%{transform:rotate(-20deg)}100%{transform:rotate(0deg)}`;
const olhos = keyframes`0%{transform:rotateX(0deg);}100%{transform:rotateX(30deg);}`;
const leftSparks = keyframes`0%{opacity:0;}`;
const dash = keyframes`0%,30%{fill:4B4B62;stroke-dashoffset:0;}80%,100%{fill:transparent;stroke-dashoffset:-200;}`;
...
export const Plugin404Burger: I404Plugin = {
  name: '404burger',
  component404: Burger,
};
